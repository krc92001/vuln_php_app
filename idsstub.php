...
try {
    ...
    */
    if (!$result->isEmpty()) {
        echo '<div style="position:fixed; right:180px; bottom:10px; overflow:visible;" id="clippy">
...
&nbsp;Hello, according to <a href="<https://github.com/ossie-git/PHPIDS"/a> it looks like you are trying to pwn my site.
